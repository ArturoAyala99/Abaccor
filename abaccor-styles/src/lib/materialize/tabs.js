(function($, anim) {
    ...
    class Tabs extends Component {
         ...
         * @param {*} target
         */
        _handleCenterLI(target) {
            if (this.tabWidth !== 0 && this.tabsWidth !== 0) {
                 var out = target.el;
                // var x = this.tabsWidth - 100;
                // var y = out.offsetWidth;
                // var z = target.index;
                // var q = 0;
                // var m = out.children;
                // for (var i = 0; i < z; i++) {
                ...
                //     q += m[i].offsetWidth;
                // }
                // var scroll=Math.max(0, q - (x - y)/2);
                out.scrollLeft=this._calcLeftPos(this.$activeTabLink)-100;
            }
        }
