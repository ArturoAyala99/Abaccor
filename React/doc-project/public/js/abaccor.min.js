...
M.checkWithinContainer = function (container, bounding, offset) {
  ...
  var containerRight = container === document.body ? Math.max(containerRect.right, window.innerWidth) : containerRect.right;
  ...
  if (scrolledX + bounding.width > containerRight - offset || scrolledX + bounding.width > window.innerWidth - offset) {
    edges.right = true;
  }
...
(function ($, anim) {
  ...
  var Collapsible = /*#__PURE__*/function (_Component) {
    ...
    function Collapsible(el, options) {
      ...
      _this = _super.call(this, Collapsible, el, options);
      _this.el.M_Collapsible = _assertThisInitialized(_this);
      /**
      ...
      _this.options = $.extend({}, Collapsible.defaults, options); // Setup tab indices

      _this.$headers = _this.$el.children('li').children('.collapsible-header');

      _this.$headers.attr('tabindex', 0);

      _this._setupEventHandlers(); // Open first active
    ...
    _createClass(Collapsible, [{
      ...
      value: function _animateIn(index) {
        ...
        if ($collapsibleLi.length) {
          var $body = $collapsibleLi.children('.collapsible-body'); //Validate if body of collapsible is undefined
...
(function ($, anim) {
  ...
  var Dropdown = /*#__PURE__*/function (_Component) {
    ...
    function Dropdown(el, options) {
      ...
      _this = _super.call(this, Dropdown, el, options);
      _this.el.M_Dropdown = _assertThisInitialized(_this);

      Dropdown._dropdowns.push(_assertThisInitialized(_this));
      ...
      _this.filterQuery = []; // Move dropdown-content after dropdown-trigger
      ...
      _this._resetFilterQueryBound = _this._resetFilterQuery.bind(_assertThisInitialized(_this));
      _this._handleDocumentClickBound = _this._handleDocumentClick.bind(_assertThisInitialized(_this));
      _this._handleDocumentTouchmoveBound = _this._handleDocumentTouchmove.bind(_assertThisInitialized(_this));
      _this._handleDropdownClickBound = _this._handleDropdownClick.bind(_assertThisInitialized(_this));
      _this._handleDropdownKeydownBound = _this._handleDropdownKeydown.bind(_assertThisInitialized(_this));
      _this._handleTriggerKeydownBound = _this._handleTriggerKeydown.bind(_assertThisInitialized(_this));
    ...
    _createClass(Dropdown, [{
      ...
      key: "_getClosestOverflowParent",
      value: function _getClosestOverflowParent() {
      ...
      value: function _getDropdownPosition() {
        ...
        if (horizontalAlignment === 'left' && !this.options.ignoreAlignment) {
          var orBody = document.body || 0;
          var diffOuter = orBody == 0 ? 0 : triggerBRect.left + idealWidth - orBody.clientWidth;
      ...
      value: function _animateOut() {
        ...
        anim({
          ...
          easing: 'easeOutQuint',
          complete: function complete(anim) {
            _this4._resetDropdownStyles(); // onCloseEnd callback
...
(function ($, anim) {
  ...
  var Modal = /*#__PURE__*/function (_Component) {
    ...
    function Modal(el, options) {
      ...
      _this = _super.call(this, Modal, el, options);
      _this.el.M_Modal = _assertThisInitialized(_this);
      /**
    ...
    _createClass(Modal, [{
      ...
      value: function _handleFocus(e) {
        var is_dropdown = $(e.target).closest('.dropdown-content').length > 0;

        if (is_dropdown) {
          var disp = $(e.target).closest('.dropdown-content')[0].style.display;
      ...
      value: function _animateOut() {
        ...
        var exitAnimOptions = {
          ...
          complete: function complete() {
            ...
            _this3.$overlay.remove(); // Call onCloseEnd callback
...
(function ($, anim) {
  ...
  var Materialbox = /*#__PURE__*/function (_Component) {
    _inherits(Materialbox, _Component);

    var _super = _createSuper(Materialbox);
    ...
    function Materialbox(el, options) {
      ...
      _this = _super.call(this, Materialbox, el, options);
      _this.el.M_Materialbox = _assertThisInitialized(_this);
      /**
       * Options for the modal
      ...
      _this.caption = _this.el.getAttribute('data-caption') || ''; // Wrap
    ...
    _createClass(Materialbox, [{
      ...
      value: function _animateImageIn() {
        ...
        var animOptions = {
          ...
          easing: 'easeOutQuad',
          complete: function complete() {
            _this2.doneAnimating = true; // onOpenEnd callback
      ...
      value: function _animateImageOut() {
        ...
        var animOptions = {
          ...
          complete: function complete() {
            ...
            _this3.originInlineStyles && _this3.$el.attr('style', _this3.originInlineStyles); // Remove class

            _this3.$el.removeClass('active');

            _this3.doneAnimating = true; // Remove overflow overrides on ancestors
...
(function ($) {
  ...
  var Parallax = /*#__PURE__*/function (_Component) {
    ...
    function Parallax(el, options) {
      ...
      _this = _super.call(this, Parallax, el, options);
      _this.el.M_Parallax = _assertThisInitialized(_this);
      /**
      ...
      Parallax._parallaxes.push(_assertThisInitialized(_this));
...
(function ($, anim) {
  ...
  var Tabs = /*#__PURE__*/function (_Component) {
    ...
    function Tabs(el, options) {
      ...
      _this = _super.call(this, Tabs, el, options);
      _this.el.M_Tabs = _assertThisInitialized(_this);
      /**
      ...
      _this.options = $.extend({}, Tabs.defaults, options); // Setup

      _this.$tabLinks = _this.$el.children('li.tab').children('a');
      _this.index = 0;

      _this._setupActiveTabLink(); // Setup tabs content
    ...
    _createClass(Tabs, [{
      ...
      key: "_handleCenterLI",
      value: function _handleCenterLI(target) {
        if (this.tabWidth !== 0 && this.tabsWidth !== 0) {
          var out = target.el; // var x = this.tabsWidth - 100;
      ...
      value: function _handleTabClick(e) {
        ...
        this._handleCenterLI(this); // Swap content
...
(function ($, anim) {
  ...
  var Tooltip = /*#__PURE__*/function (_Component) {
    ...
    function Tooltip(el, options) {
      ...
      _this.el.M_Tooltip = _assertThisInitialized(_this);
    ...
    _createClass(Tooltip, [{
      ...
      value: function _appendTooltipEl() {
        ...
        var addInside = this.el.dataset.addinside;
      ...
      value: function _updateTooltipContent() {
        ...
        var translateOption = this.el.getAttribute('data-translate') || false;

        if (translateOption) {
          //se valida que el siguiente elemento sea un clv-t para asignar el texto correspondiente
          var translate = this.$el.next() || null;
...
(function ($, anim) {
  ...
  var Sidenav = /*#__PURE__*/function (_Component) {
    ...
    function Sidenav(el, options) {
      ...
      _this = _super.call(this, Sidenav, el, options);
      _this.el.M_Sidenav = _assertThisInitialized(_this);
      _this.id = _this.$el.attr('id');
      /**
      ...
      _this.isDragged = false; // Window size variables for window resize checks
      ...
      Sidenav._sidenavs.push(_assertThisInitialized(_this));
    ...
    _createClass(Sidenav, [{
      ...
      value: function close() {
        ...
        if (this._isCurrentlyFixed()) {
          ...
          this.el.style.transform = "translateX(".concat(transformX, ")"); // Handle non-fixed Sidenav
        } else {
          this._enableBodyScrolling();
...
(function ($, anim) {
  ...
  var ScrollSpy = /*#__PURE__*/function (_Component) {
    ...
    function ScrollSpy(el, options) {
      ...
      _this = _super.call(this, ScrollSpy, el, options);
      _this.el.M_ScrollSpy = _assertThisInitialized(_this);
      /**
       * Options for the modal
       * @member Modal#options
      ...
      ScrollSpy._elements.push(_assertThisInitialized(_this));
...
(function ($) {
  ...
  var Autocomplete = /*#__PURE__*/function (_Component) {
    ...
    function Autocomplete(el, options) {
      ...
      _this = _super.call(this, Autocomplete, el, options);
      _this.el.M_Autocomplete = _assertThisInitialized(_this);
      /**
      ...
      _this.options = $.extend({}, Autocomplete.defaults, options); // Setup
...
(function ($) {
  ...
  M.validate_field = function (object) {
    var element = object.tagName === undefined ? object[0] : object;
    var suffix = element.previousElementSibling;
    var prefix = suffix != null ? suffix.previousElementSibling : null;
    var parent = element.parentElement;

    if (element.classList.contains("select-dropdown") && parent.classList.contains("validate")) {
      var selectValidate = parent.lastElementChild,
          ul = parent.querySelector("ul"),
          _suffix = parent.previousElementSibling,
          _prefix = _suffix != null ? _suffix.previousElementSibling : null;

      if (ul && ul.style.display != "block" && selectValidate.hasAttribute("required")) {
        show_validate(!selectValidate.validity.valid, element, _prefix, _suffix, parent);
      }
    } else {
      var hasValid = element.validity.valid;
      var lenAttr = parseInt(element.getAttribute("data-length"));
      var hasReadOnly = null !== element.getAttribute("readOnly") ? element.readOnly : false;
      var hasRequired = null !== element.getAttribute('required') ? element.required : false;
      var haveRegExp = null !== element.getAttribute("pattern") || false;
      var id = null !== element.getAttribute("id") ? element.id : null;
      var name = null !== element.getAttribute("name") ? element.name : id;
      ...
      if (element.nodeName == 'INPUT' && element.type == 'radio' && name != null) {
        ...
        var _options = element.selectedOptions;
        var optionsSelect = [];

        for (var i = 0; i < _options.length; i++) {
          if (_options[i].value.trim() != "") {
            optionsSelect.push(_options[i].value);
          }
        }
      ...
      if (!hasValid) {
        ...
        if (haveRegExp) {
          var er = new RegExp(element.pattern);
  ...
  $(document).ready(function () {
    ...
    var text_area_selector = '.abaccor-textarea';
...
(function ($, anim) {
  ...
  var Slider = /*#__PURE__*/function (_Component) {
    ...
    function Slider(el, options) {
      ...
      _this = _super.call(this, Slider, el, options);
      _this.el.M_Slider = _assertThisInitialized(_this);
      /**
       * Options for the modal
      ...
      _this.options = $.extend({}, Slider.defaults, options); // setup
      ...
      _this._setSliderHeight(); // Set initial positions of captions
      ...
      _this._setupIndicators(); // Show active slide
      ...
      if (_this.$active) {
        ...
        _this.activeIndex = 0;
        _this.$active = _this.$slides.eq(_this.activeIndex); // Update indicators
      ...
      _this._setupEventHandlers(); // auto scroll
...
(function ($) {
  ...
  var Chips = /*#__PURE__*/function (_Component) {
    ...
    function Chips(el, options) {
      ...
      _this = _super.call(this, Chips, el, options);
      _this.el.M_Chips = _assertThisInitialized(_this);
      /**
       * Options for the modal
      ...
      _this.hasAutocomplete = Object.keys(_this.options.autocompleteOptions).length > 0; // Set input id
...
(function ($) {
  ...
  var Pushpin = /*#__PURE__*/function (_Component) {
    ...
    function Pushpin(el, options) {
      ...
      _this = _super.call(this, Pushpin, el, options);
      _this.el.M_Pushpin = _assertThisInitialized(_this);
      /**
       * Options for the modal
      ...
      Pushpin._pushpins.push(_assertThisInitialized(_this));
...
(function ($, anim) {
  ...
  var FloatingActionButton = /*#__PURE__*/function (_Component) {
    ...
    function FloatingActionButton(el, options) {
      ...
      _this = _super.call(this, FloatingActionButton, el, options);
      _this.el.M_FloatingActionButton = _assertThisInitialized(_this);
      /**
       * Options for the fab
      ...
      if (_this.options.direction === 'right' || _this.options.direction === 'left') {
        var buttons = _this.$el.children('a');
        ...
        _this.$menu[0].style.right = right + "px";
      }
...
(function ($) {
  ...
  var Datepicker = /*#__PURE__*/function (_Component) {
    ...
    function Datepicker(el, options) {
      ...
      _this = _super.call(this, Datepicker, el, options);
      _this.el.M_Datepicker = _assertThisInitialized(_this);
      _this.options = $.extend({}, Datepicker.defaults, options); // make sure i18n defaults are not lost when only few i18n option properties are passed
    ...
    _createClass(Datepicker, [{
      ...
      value: function _handleInputChange(e) {
        var date; // Prevent change event from being fired when triggered by the plugin
...
(function ($) {
  ...
  var Timepicker = /*#__PURE__*/function (_Component) {
    ...
    function Timepicker(el, options) {
      ...
      _this = _super.call(this, Timepicker, el, options);
      _this.el.M_Timepicker = _assertThisInitialized(_this);
...
(function ($) {
  ...
  var CharacterCounter = /*#__PURE__*/function (_Component) {
    ...
    function CharacterCounter(el, options) {
      ...
      _this = _super.call(this, CharacterCounter, el, options);
      _this.el.M_CharacterCounter = _assertThisInitialized(_this);
      /**
...
(function ($) {
  ...
  var Carousel = /*#__PURE__*/function (_Component) {
    ...
    function Carousel(el, options) {
      ...
      _this = _super.call(this, Carousel, el, options);
      _this.el.M_Carousel = _assertThisInitialized(_this);
      /**
      ...
      _this.options = $.extend({}, Carousel.defaults, options); // Setup
      ...
      _this._autoScrollBound = _this._autoScroll.bind(_assertThisInitialized(_this));
      _this._trackBound = _this._track.bind(_assertThisInitialized(_this)); // Full Width carousel setup

      if (_this.options.fullWidth) {
        _this.options.dist = 0;

        _this._setCarouselHeight(); // Offset fixed items when indicators.
      ...
      _this.count = _this.images.length; // Cap numVisible at count

      _this.options.numVisible = Math.min(_this.count, _this.options.numVisible); // Setup cross browser string
...
(function ($) {
  ...
  var TapTarget = /*#__PURE__*/function (_Component) {
    _inherits(TapTarget, _Component);

    var _super = _createSuper(TapTarget);
    ...
    function TapTarget(el, options) {
      ...
      _this = _super.call(this, TapTarget, el, options);
      _this.el.M_TapTarget = _assertThisInitialized(_this);
      /**
...
(function ($) {
  ...
  var FormSelect = /*#__PURE__*/function (_Component) {
    ...
    function FormSelect(el, options) {
      ...
      _this = _super.call(this, FormSelect, el, options); // Don't init if browser default version

      if (_this.$el.hasClass('browser-default')) {
        return _possibleConstructorReturn(_this);
      }

      _this.el.M_FormSelect = _assertThisInitialized(_this);
      /**
       * Options for the select
      ...
      _this.inputSearch = null;
      _this.containerCheckAll = null;
      _this.inputCheckAll = null;
      _this.id = M.guid();
      _this.el.tabIndex = -1;
      _this._keysSelected = {};
    ...
    _createClass(FormSelect, [{
      ...
      value: function _setupEventHandlers() {
        ...
        this._handleInputClickBound = this._handleInputClick.bind(this);
        $(this.dropdownOptions).find('li:not(.optgroup):not(.container-search):not(.container-check-all)').each(function (el) {
        ...
        if (this.options.useSearch) {
          ...
          $(this.dropdownOptions).find('li.container-search>div>input').each(function (el) {
            _this2.inputSearch = el;

            _this2.inputSearch.addEventListener('focus', _this2._onFocusSearchBound);

            _this2.inputSearch.addEventListener('blur', _this2._onBlurSearchBound);

            _this2.inputSearch.addEventListener('keyup', _this2._onKeyUpSearchBound);

            _this2.inputSearch.addEventListener('keydown', _this2._onKeyDownSearchBound);
          });
        }

        if (this.isMultiple && this.options.useCheckAll) {
          this._onClickCheckAllBound = this._onClickCheckAll.bind(this);
          $(this.dropdownOptions).find('li.container-check-all').each(function (el) {
            _this2.containerCheckAll = el;
            _this2.inputCheckAll = el.firstElementChild.firstElementChild.firstElementChild || null;

            _this2.containerCheckAll.addEventListener('click', _this2._onClickCheckAllBound);
          });
        }
      }
      /**
      ...
      value: function _setupDropdown() {
        ...
        this.wrapper.id = "select-wrapper-".concat(this.id);
        this.$el.before($(this.wrapper));
        ...
        this.dropdownOptions.id = "select-options-".concat(this.id);
        ...
        if (this.$selectOptions.length) {
          if (this.options.useSearch) {
            $(this.dropdownOptions).append($("<li class=\"container-search floating-header\" tabindex=\"-1\">\n\t\t\t\t\t\t\t\t<div class=\"input-field\">\n\t\t\t\t\t\t\t\t\t<i class=\"material-icons suffix\">search</i>\n\t\t\t\t\t\t\t\t\t<input id=\"input-search-".concat(this.id, "\" type=\"search\" placeholder=\"Search\" class=\"active\">\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</li>")));
          }

          if (this.isMultiple && this.options.useCheckAll) {
            $(this.dropdownOptions).append($("<li class=\"container-check-all\" tabindex=\"-1\">\n\t\t\t\t\t\t\t\t<span>\n\t\t\t\t\t\t\t\t\t<label>\n\t\t\t\t\t\t\t\t\t\t<input type=\"checkbox\">\n\t\t\t\t\t\t\t\t\t\t<span>".concat(this.options.textCheckAll, "</span>\n\t\t\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t\t\t</span>\n\t\t\t\t\t\t\t</li>")));
          }
        ...
        if (!this.el.disabled) {
          ...
          dropdownOptions.onOpenEnd = function (el) {
            ...
            if (selectedOption.length) {
              ...
              if (_this4.inputSearch != null) {
                _this4.inputSearch.focus();
              }
            }
          };
          ...
          if (this.options.useSearch) {
            dropdownOptions.onOpenStart = function (el) {
              _this4._onOpenStartSearch(_this4);
            };

            dropdownOptions.onCloseStart = function (el) {
              _this4._onCloseStartSearch(_this4);
            };
          }
      ...
      */
      ...
      key: "_onFocusSearch",
      value: function _onFocusSearch(autoFocus) {
        if (!autoFocus) {
      ...
      */
      ...
      key: "_rpChar",
      value: function _rpChar(value) {
        if (!value) return "";
        return value.toUpperCase().replace(/[ÃÀÁÄÂÈÉËÊÌÍÏÎÒÓÖÔÙÚÜÛÇ]/ig, function (e) {
          return specialCharacters[e];
        });
      }
      /**
      ...
      key: "_searchValueInput",
      value: function _searchValueInput(childrens, value) {
        var _this5 = this;

        value = this._rpChar(value);
        Object.keys(childrens).map(function (key) {
          var child = childrens[key];
          var option = child.el;

          if (_typeof(option) != 'object' || !child.optionEl) {
            return;
          }

          child.optionEl.hidden = typeof option.text != "undefined" && _this5._rpChar(option.text).indexOf(value) === -1;
        });
      }
      /**
      ...
      key: "_onKeyDownSearch",
      value: function _onKeyDownSearch(e) {
      ...
      */
      ...
      key: "_onOpenStartSearch",
      value: function _onOpenStartSearch(value) {
        var dropdownOptions = this.options.dropdownOptions;
      ...
      key: "_onCloseStartSearch",
      value: function _onCloseStartSearch(value) {
        var _this$options = this.options,
            useSearch = _this$options.useSearch,
      ...
      key: "_onClickCheckAll",
      value: function _onClickCheckAll(e) {
        e.preventDefault();

        var _ref = this.inputCheckAll || false,
      ...
      key: "setChangeCheckAll",
      value: function setChangeCheckAll(isChecked) {
        var _this6 = this;

        if (!this.isMultiple || !this._valueDict) return;
        Object.keys(this._valueDict).map(function (key) {
          var child = _this6._valueDict[key];
          var element = child.el || undefined;

          if (element == undefined || $(element).hasClass("container-check-all") || $(element).hasClass("container-search")) {
            return;
          }

          var check = child.optionEl.getElementsByTagName("input")[0] || undefined;
      ...
      key: "_setCheckState",
      value: function _setCheckState() {
        if (this.inputCheckAll != null) {
          var countOptions = 0;

          for (var key in this._valueDict) {
            var option = this._valueDict[key];
            var element = $(option.optionEl);
          ...
          var countSelected = Object.keys(this._keysSelected).length || 0;
          var check = countSelected > 0 && countSelected == countOptions;
...
(function ($, anim) {
  ...
  var Range = /*#__PURE__*/function (_Component) {
    ...
    function Range(el, options) {
      ...
      _this = _super.call(this, Range, el, options);
      _this.el.M_Range = _assertThisInitialized(_this);
      /**
...
var C = {
  FloatingSheetButton: undefined,
  version: '21.04.15.1' //Año.Mes.Dia.Numero_Publicacion
 ...
 *
 */
var FloatingSheetButton = /*#__PURE__*/function (_Component) {
  "use strict";

  _inherits(FloatingSheetButton, _Component);

  var _super = _createSuper(FloatingSheetButton);
   ...
   * @param {Object} options
   */
  function FloatingSheetButton(el, options) {
    var _this;

    _classCallCheck(this, FloatingSheetButton);

    _this = _super.call(this, FloatingSheetButton, el, options);
    _this.el.C_FloatingSheetButton = _assertThisInitialized(_this);
    /**
     * Options for the FBS
    ...
    _this.options = Object.assign({}, FloatingSheetButton.defaults, options);
    _this.isOpen = false;
  ...
  _createClass(FloatingSheetButton, [{
    key: "destroy",
    value:
    /**
     * Teardown component
    ...
    function destroy() {
      ...
      var parent = this._overlay.parentNode;
    ...
    value: function open() {
      ...
      this._overlay.style.display = 'block';
      this.isOpen = true; // onOpenEnd callback
    ...
    value: function close() {
      ...
      this._overlay.style.display = 'none';
      this.isOpen = false; // onCloseEnd callback
    ...
    value: function setDisabled(disabled) {
      var hasClassDisabled = this.el.classList.contains('disabled');
      var isDisabled = disabled === undefined ? true : disabled;
    ...
    key: "setOpenStart",
    value: function setOpenStart(event) {
    ...
    key: "setOpenEnd",
    value: function setOpenEnd(event) {
    ...
    key: "setCloseStart",
    value: function setCloseStart(event) {
    ...
    key: "setCloseEnd",
    value: function setCloseEnd(event) {
    ...
    key: "init",
    value: function init(els, options) {
      return _get(_getPrototypeOf(FloatingSheetButton), "init", this).call(this, this, els, options);
    }
    /**
     * Get Instance
     */
  ...
  return FloatingSheetButton;
}(Component); //Asigna la referencia al index
...
var COMPONENTSCLASS = {
  "carousel": function carousel(element) {
    return window.M.Carousel.getInstance(element);
  },
  "collapsible": function collapsible(element) {
    return window.M.Collapsible.getInstance(element);
  },
  "datepicker": function datepicker(element) {
    return window.M.Datepicker.getInstance(element);
  },
  "dropdown-trigger": function dropdownTrigger(element) {
    return window.M.Dropdown.getInstance(element);
  },
  "materialboxed": function materialboxed(element) {
    return window.M.Materialbox.getInstance(element);
  },
  "modal": function modal(element) {
    return window.M.Modal.getInstance(element);
  },
  "parallax": function parallax(element) {
    return window.M.Parallax.getInstance(element);
  },
  "pushpin": function pushpin(element) {
    return window.M.Pushpin.getInstance(element);
  },
  "scrollspy": function scrollspy(element) {
    return window.M.ScrollSpy.getInstance(element);
  },
  "sidenav": function sidenav(element) {
    return window.M.Sidenav.getInstance(element);
  },
  "slider": function slider(element) {
    return window.M.Slider.getInstance(element);
  },
  "tabs": function tabs(element) {
    return window.M.Tabs.getInstance(element);
  },
  "tap-target": function tapTarget(element) {
    return window.M.TapTarget.getInstance(element);
  },
  "tooltipped": function tooltipped(element) {
    return window.M.Tooltip.getInstance(element);
  },
  "chips": function chips(element) {
    return window.M.Chips.getInstance(element);
  },
  "fixed-action-btn": function fixedActionBtn(element) {
    return window.M.FloatingActionButton.getInstance(element);
  }
};
/**
* @author Angel Solis <angesolis@palaceresorts.com>
...
var COMPONENTSTYPE = {
  "select": function select(element) {
    return window.M.FormSelect.getInstance(element);
  }
};
/**
...
MComponentes.getSelectElements = function (query) {
...
MComponentes.carousel = function (elems) {
...
MComponentes.Collapsible = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Dropdown = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.TapTarget = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Materialbox = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Slider = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Modal = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Parallax = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Pushpin = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.ScrollSpy = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Sidenav = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Tabs = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Tooltip = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.toast = function (htmlMsn) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
...
MComponentes.Select = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.DatePicker = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.Chip = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.FloatingActionButton = function (elems) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var elements = MComponentes.getSelectElements(elems);
...
MComponentes.getInstance = function (elem) {
  var element = typeof elem == 'string' ? document.querySelector(elem) : elem;
  ...
  var listClass = element.className.split(" ");
  var foundClassName = listClass.find(function (val) {
    return COMPONENTSCLASS.hasOwnProperty(val);
  });

  if (foundClassName != undefined) {
    foundInstance = COMPONENTSCLASS[foundClassName](element);
  }
  ...
  var foundTagName = COMPONENTSTYPE.hasOwnProperty(element.tagName.toLowerCase());

  if (foundTagName) {
    foundInstance = COMPONENTSTYPE[element.tagName.toLowerCase()](element);
  }
...
MComponentes.updateTextFields = function () {
  return window.M.updateTextFields();
};

MComponentes.ValidateDataForm = function (form) {
  ...
  for (var i = 0; i < elements.length; i++) {
    ...
    if (element.name) {
      var elementValid = M.validate_field(element);
